        ...
        <table class="w-full text-left">
          ...
          <tbody class="divide-y divide-outline-variant/10">
            ...
            <tr v-if="items.length === 0">
              <td colspan="6" class="px-6 py-12 text-center text-on-surface-variant text-label-md">Belum ada data tahun ajaran. Klik "Tambah Tahun Ajaran" untuk menambahkan.</td>
            </tr>
          </tbody>
        </table>
      </div>
